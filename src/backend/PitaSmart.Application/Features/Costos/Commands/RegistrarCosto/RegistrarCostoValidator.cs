...
/// <summary>
/// Validador FluentValidation para <see cref="RegistrarCostoCommand"/>.
/// </summary>
public class RegistrarCostoValidator : AbstractValidator<RegistrarCostoCommand>
{
    ...
    public RegistrarCostoValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty()
        ...
        RuleFor(x => x.LoteId)
            .NotEmpty()
            .WithMessage("El ID del lote es requerido.");
        ...
        RuleFor(x => x.ClientTimestamp)
            .NotEmpty()
            .WithMessage("El timestamp del cliente es requerido.");
    }
}
